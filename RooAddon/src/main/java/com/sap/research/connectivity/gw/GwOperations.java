...
public interface GwOperations {
	...
	void addFieldsAndMethods(String namespace, String remoteEntity, boolean importAll);

	void addFieldInGWClass(String localClassName, String fieldName) throws Exception;
